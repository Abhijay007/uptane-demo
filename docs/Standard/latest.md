...
- 2.1. [Conformance terminology](#rfc.section.2.1)
- 2.2. [Uptane role terminology](#rfc.section.2.2)
- 2.3. [Acronyms and abbreviations](#rfc.section.2.3)

- 3\. [Rationale for and scope of the Uptane Standard](#rfc.section.3)

- 3.1. [Why Uptane requires a standards document](#rfc.section.3.1)
- 3.2. [Scope of Standard coverage](#rfc.section.3.2)

- 3.2.1. [Assumptions](#rfc.section.3.2.1)
- 3.2.2. [Use cases](#rfc.section.3.2.2)

- 3.3. [Exceptions](#rfc.section.3.3)
- 3.4. [Out of scope](#rfc.section.3.4)
- 3.5. [Design requirements](#rfc.section.3.5)

- 4\. [Threat model and attack strategies](#rfc.section.4)

- 4.1. [Attacker goals](#rfc.section.4.1)
- 4.2. [Attacker capabilities](#rfc.section.4.2)
- 4.3. [Description of threats](#rfc.section.4.3)

- 4.3.1. [Read updates](#rfc.section.4.3.1)
- 4.3.2. [Deny installation of updates](#rfc.section.4.3.2)
- 4.3.3. [Interfere with ECU functionality](#rfc.section.4.3.3)
- 4.3.4. [Control an ECU or vehicle](#rfc.section.4.3.4)

- 5\. [Detailed design of Uptane](#rfc.section.5)

- 5.1. [Roles on repositories](#rfc.section.5.1)

- 5.1.1. [The Root role](#rfc.section.5.1.1)
- 5.1.2. [The Targets role](#rfc.section.5.1.2)
- 5.1.3. [The Snapshot role](#rfc.section.5.1.3)
- 5.1.4. [The Timestamp role](#rfc.section.5.1.4)

- 5.2. [Metadata structures](#rfc.section.5.2)

- 5.2.1. [Common metadata structures](#rfc.section.5.2.1)
- 5.2.2. [Root metadata](#rfc.section.5.2.2)
- 5.2.3. [Targets metadata](#rfc.section.5.2.3)
- 5.2.4. [Snapshot metadata](#rfc.section.5.2.4)
- 5.2.5. [Timestamp metadata](#rfc.section.5.2.5)
- 5.2.6. [Repository mapping metadata](#rfc.section.5.2.6)
- 5.2.7. [Rules for filenames in repositories and metadata](#rfc.section.5.2.7)

- 5.3. [Server / repository implementation requirements](#rfc.section.5.3)

- 5.3.1. [Image repository](#rfc.section.5.3.1)
- 5.3.2. [Director repository](#rfc.section.5.3.2)

- 5.4. [In-vehicle implementation requirements](#rfc.section.5.4)

- 5.4.1. [Build-time prerequisite requirements for ECUs](#rfc.section.5.4.1)
- 5.4.2. [What the Primary does](#rfc.section.5.4.2)
- 5.4.3. [Installing images on Primary or Secondary ECUs](#rfc.section.5.4.3)
- 5.4.4. [Metadata verification procedures](#rfc.section.5.4.4)

- 6\. [References](#rfc.references)

- 6.1. [Normative References](#rfc.references.1)
- 6.2. [Informative References](#rfc.references.2)

- [Author's Address](#rfc.authors)
...
# [2.](#rfc.section.2) [Terminology](#terminology)
...
# [2.1.](#rfc.section.2.1) [Conformance terminology](#conformance-terminology)
...
# [2.2.](#rfc.section.2.2) [Uptane role terminology](#uptane-role-terminology)
...
# [2.3.](#rfc.section.2.3) [Acronyms and abbreviations](#acronyms-and-abbreviations)
...
# [3.](#rfc.section.3) [Rationale for and scope of the Uptane Standard](#rationale-for-and-scope-of-the-uptane-standard)
...
# [3.1.](#rfc.section.3.1) [Why Uptane requires a standards document](#why-uptane-requires-a-standards-document)
...
# [3.2.](#rfc.section.3.2) [Scope of Standard coverage](#scope-of-standard-coverage)
...
# [3.2.1.](#rfc.section.3.2.1) [Assumptions](#assumptions)
...
# [3.2.2.](#rfc.section.3.2.2) [Use cases](#use-cases)
...
# [3.2.2.1.](#rfc.section.3.2.2.1) [OEMs initializing Uptane at the factory using SOTA](#oems-initializing-uptane-at-the-factory-using-sota)
...
# [3.2.2.2.](#rfc.section.3.2.2.2) [Updating one ECU with a complete image](#updating-one-ecu-with-a-complete-image)
...
# [3.2.2.3.](#rfc.section.3.2.2.3) [Updating individual ECUs on demand](#updating-individual-ecus-on-demand)
...
# [3.2.2.4.](#rfc.section.3.2.2.4) [Update one ECU with multiple deltas](#update-one-ecu-with-multiple-deltas)
...
# [3.3.](#rfc.section.3.3) [Exceptions](#exceptions)
...
# [3.4.](#rfc.section.3.4) [Out of scope](#out-of-scope)
...
# [3.5.](#rfc.section.3.5) [Design requirements](#design-requirements)
...
# [4.](#rfc.section.4) [Threat model and attack strategies](#threat-model-and-attack-strategies)
...
# [4.1.](#rfc.section.4.1) [Attacker goals](#attacker_goals)
...
# [4.2.](#rfc.section.4.2) [Attacker capabilities](#capabilities)
...
# [4.3.](#rfc.section.4.3) [Description of threats](#threats)
...
# [4.3.1.](#rfc.section.4.3.1) [Read updates](#read_updates)
...
# [4.3.2.](#rfc.section.4.3.2) [Deny installation of updates](#deny_updates)
...
# [4.3.3.](#rfc.section.4.3.3) [Interfere with ECU functionality](#change_functionality)
...
# [4.3.4.](#rfc.section.4.3.4) [Control an ECU or vehicle](#control_ecu)
...
# [5.](#rfc.section.5) [Detailed design of Uptane](#design)
...
# [5.1.](#rfc.section.5.1) [Roles on repositories](#roles)
...
# [5.1.2.1.](#rfc.section.5.1.2.1) [Delegations](#targets_role_delegations)
...
# [5.1.3.](#rfc.section.5.1.3) [The Snapshot role](#snapshot_role)
...
# [5.1.4.](#rfc.section.5.1.4) [The Timestamp role](#timestamp_role)
...
# [5.2.](#rfc.section.5.2) [Metadata structures](#meta_structures)
...
# [5.2.1.](#rfc.section.5.2.1) [Common metadata structures](#common_metadata)
...
# [5.2.2.](#rfc.section.5.2.2) [Root metadata](#root_meta)
...
# [5.2.3.](#rfc.section.5.2.3) [Targets metadata](#targets_meta)
...
# [5.2.3.1.](#rfc.section.5.2.3.1) [Metadata about images](#targets_images_meta)
...
# [5.2.3.1.1.](#rfc.section.5.2.3.1.1) [Custom metadata about images](#custom-metadata-about-images)
...
# [5.2.3.2.](#rfc.section.5.2.3.2) [Metadata about delegations](#delegations_meta)
...
# [5.2.4.](#rfc.section.5.2.4) [Snapshot metadata](#snapshot_meta)
...
# [5.2.5.](#rfc.section.5.2.5) [Timestamp metadata](#timestamp_meta)
...
# [5.2.6.](#rfc.section.5.2.6) [Repository mapping metadata](#repo_mapping_meta)
...
# [5.2.7.](#rfc.section.5.2.7) [Rules for filenames in repositories and metadata](#metadata_filename_rules)
...
# [5.3.](#rfc.section.5.3) [Server / repository implementation requirements](#server-repository-implementation-requirements)
...
# [5.3.1.](#rfc.section.5.3.1) [Image repository](#image-repository)
...
# [5.3.2.](#rfc.section.5.3.2) [Director repository](#director_repository)
...
# [5.3.2.1.](#rfc.section.5.3.2.1) [Directing installation of images on vehicles](#directing-installation-of-images-on-vehicles)
...
# [5.3.2.2.](#rfc.section.5.3.2.2) [Inventory Database](#inventory_db)
...
# [5.4.](#rfc.section.5.4) [In-vehicle implementation requirements](#in-vehicle-implementation-requirements)
...
# [5.4.1.](#rfc.section.5.4.1) [Build-time prerequisite requirements for ECUs](#build-time-prerequisite-requirements-for-ecus)
...
# [5.4.2.](#rfc.section.5.4.2) [What the Primary does](#what-the-primary-does)
...
# [5.4.2.1.](#rfc.section.5.4.2.1) [Construct and send vehicle version manifest](#construct_manifest_primary)
...
# [5.4.2.1.1.](#rfc.section.5.4.2.1.1) [Vehicle version manifest](#vehicle_version_manifest)
...
# [5.4.2.1.2.](#rfc.section.5.4.2.1.2) [ECU version report](#version_report)
...
# [5.4.2.2.](#rfc.section.5.4.2.2) [Download and check current time](#check_time_primary)

The Primary SHALL load the current time from a secure source.

# [5.4.2.3.](#rfc.section.5.4.2.3) [Download and verify metadata](#download_meta_primary)
...
# [5.4.2.4.](#rfc.section.5.4.2.4) [Download and verify images](#download_images_primary)
...
# [5.4.2.5.](#rfc.section.5.4.2.5) [Send latest time to Secondaries](#send_time_primary)

The Primary SHOULD send the time to each ECU.

# [5.4.2.6.](#rfc.section.5.4.2.6) [Send metadata to Secondaries](#send_metadata_primary)
...
# [5.4.2.7.](#rfc.section.5.4.2.7) [Send images to Secondaries](#send_images_primary)
...
# [5.4.3.](#rfc.section.5.4.3) [Installing images on Primary or Secondary ECUs](#installing-images-on-primary-or-secondary-ecus)
...
# [5.4.3.1.](#rfc.section.5.4.3.1) [Load and verify the latest attested time](#verify_time)
...
# [5.4.3.2.](#rfc.section.5.4.3.2) [Verify metadata](#verify_metadata)
...
# [5.4.3.3.](#rfc.section.5.4.3.3) [Download latest image](#download_image)
...
# [5.4.3.4.](#rfc.section.5.4.3.4) [Verify image](#verify_image)
...
# [5.4.3.5.](#rfc.section.5.4.3.5) [Install image](#install_image)
...
# [5.4.3.6.](#rfc.section.5.4.3.6) [Create and send version report](#create_version_report)
...
# [5.4.4.](#rfc.section.5.4.4) [Metadata verification procedures](#metadata_verification)
...
# [5.4.4.1.](#rfc.section.5.4.4.1) [Partial verification](#partial_verification)
...
# [5.4.4.2.](#rfc.section.5.4.4.2) [Full verification](#full_verification)
...
# [5.4.4.3.](#rfc.section.5.4.4.3) [How to check Root metadata](#check_root)
...
# [5.4.4.4.](#rfc.section.5.4.4.4) [How to check Timestamp metadata](#check_timestamp)
...
# [5.4.4.5.](#rfc.section.5.4.4.5) [How to check Snapshot metadata](#check_snapshot)
...
# [5.4.4.6.](#rfc.section.5.4.4.6) [How to check Targets metadata](#check_targets)

To properly check Targets metadata, an ECU SHOULD:

1.  Download up to Z number of bytes, constructing the metadata filename as defined in [Section 5.2.7](#metadata_filename_rules). The value for Z is set by the implementer. For example, Z could be tens of kilobytes.
...
# [5.4.4.7.](#rfc.section.5.4.4.7) [How to resolve delegations](#resolve_delegations)
...
# [5.4.4.8.](#rfc.section.5.4.4.8) [Multi-role delegations](#multirole_delegations)
...
# [6.](#rfc.references) References

# [6.1.](#rfc.references.1) Normative References
...
# [6.2.](#rfc.references.2) Informative References
